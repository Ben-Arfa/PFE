...
class DailyEntriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Saisie quotidienne — ${lot.identifier}')),
      ...
      body: StreamBuilder<List<DailyEntry>>(
        ...
        builder: (context, snapshot) {
          ...
          // compute KPI lists
          final deaths = entries.map((e) => e.deathsToday.toDouble()).toList();
          ...
          double? latestAvgWeight = weights.isNotEmpty ? weights.last : null;
          ...
          double? eggRateToday = entries.isNotEmpty && lot.currentBirdCount > 0
              ? (entries.last.eggsToday ?? 0) / lot.currentBirdCount * 100
              : null;
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    if (gmq != null)
                      Chip(label: Text('GMQ: ${gmq.toStringAsFixed(3)} kg/j')),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (!isLayer) ...[
                          ...
                          Sparkline(values: weights, color: Colors.blue),
                        ] else ...[
                            ...
                            values: eggs
                                .map(
                                  (e) => lot.currentBirdCount > 0
                                      ? (e.toDouble() / lot.currentBirdCount) *
                                            100
                                      : 0.0,
                                )
                                .toList(),
